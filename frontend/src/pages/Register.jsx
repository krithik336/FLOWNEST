      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-brand-text/60">
            Start organizing your projects and tasks in seconds
          </p>
        </div>
        ...
        <div className="bg-brand-surface border border-brand-border/60 rounded-2xl p-8 shadow-2xl backdrop-blur-md">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            {/* Full Name Field */}
            <div>
              <label htmlFor="name" className="block text-xs font-semibold uppercase tracking-wider text-brand-text/50 mb-2">
                Full Name
              </label>
          ...
          <div className="mt-6 text-center text-sm">
            <span className="text-brand-text/55">Already have an account? </span>
            <Link to="/login" className="font-semibold text-brand-accent hover:text-brand-accent/80 transition-colors">
              Log in instead
            </Link>
          </div>
        </div>
